...
class Parameters():
	def __init__(self):
		...
		# self.train_video = ['00_tovis', '01_tovis', '02_tovis', '05_tovis', '08_tovis', '09_tovis']
		# self.valid_video = ['04_tovis', '06_tovis', '07_tovis', '10_tovis']
		...
		# Data info path
		self.train_data_info_path = 'datainfo/train_df_t{}_v{}_p{}_seq{}x{}_sample{}.pickle'.format(''.join(self.train_video), ''.join(self.valid_video), self.partition, self.seq_len, self.seq_len, self.sample_times)
		self.valid_data_info_path = 'datainfo/valid_df_t{}_v{}_p{}_seq{}x{}_sample{}.pickle'.format(''.join(self.train_video), ''.join(self.valid_video), self.partition, self.seq_len, self.seq_len, self.sample_times)
